...
public class AsymMM3Tot
{
  public static void main(String args[])
  {
    ...
    while(inputStream.hasNextDouble())
    {
      ...
      sum[0]=sum[0]+(ya[0][t]*Math.abs(xa[0][t])); 
      sum1[0]=sum1[0]+(Math.abs(xb[0][t])*yb[0][t]); 
      sum2[0]=sum2[0]+(y2[0][t]*Math.abs(x2[0][t]));
    ...
    while(inputStream.hasNextDouble())
    {
      ...
      sum[1]=sum[1]+(ya[1][u]*Math.abs(xa[1][u])); 
      sum1[1]=sum1[1]+(Math.abs(xb[1][u])*yb[1][u]); 
      sum2[1]=sum2[1]+(y2[1][u]*Math.abs(x2[1][u]));
    ...
    while(inputStream.hasNextDouble())
    {
      ...
      sum[2]=sum[2]+(ya[2][v]*Math.abs(xa[2][v])); 
      sum1[2]=sum1[2]+(Math.abs(xb[2][v])*yb[2][v]); 
      sum2[2]=sum2[2]+(y2[2][v]*Math.abs(x2[2][v]));
    ...
    while(inputStream.hasNextDouble())
    {
      ...
      sum[3]=sum[3]+(ya[3][w]*Math.abs(xa[3][w])); 
      sum1[3]=sum1[3]+(Math.abs(xb[3][w])*yb[3][w]); 
      sum2[3]=sum2[3]+(y2[3][w]*Math.abs(x2[3][w]));
    ...
    while(inputStream.hasNextDouble())
    {
      ...
      sum[4]=sum[4]+(ya[4][x]*Math.abs(xa[4][x])); 
      sum1[4]=sum1[4]+(Math.abs(xb[4][x])*yb[4][x]); 
      sum2[4]=sum2[4]+(y2[4][x]*Math.abs(x2[4][x]));
 ...
 try //Table 6
    ...
    while(inputStream.hasNextDouble())
    {
      ...
      sum[5]=sum[5]+(ya[5][l]*Math.abs(xa[5][l])); 
      sum1[5]=sum1[5]+(Math.abs(xb[5][l])*yb[5][l]);
      sum2[5]=sum2[5]+(y2[5][l]*Math.abs(x2[5][l]));
  ...
  for(int i=0; i<erA.length; i++)
	...
	erA[n]=(2/p)*Math.sqrt(((sum[n])*(sum1[n]))/(Math.pow(sum2[n],3))); 
