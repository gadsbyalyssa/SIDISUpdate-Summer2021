...
c011->cd(1);
PtPt->GetXaxis()->SetTitle("P_Tp*P_Tk");
...
///////////////////////////////////////////////////////////////
TCanvas*c040 = new TCanvas("c040", "PKplus", 1600,1100);
c040->Divide(1,1);
c040->Print("x.pdf[");
TH1F*X = new TH1F("X","X",100, 0,1);
c040->cd(1);
X->GetXaxis()->SetTitle("x-bjorken");
X->GetXaxis()->SetTitleSize(0.04);
X->GetXaxis()->SetLabelSize(0.04);
X->GetYaxis()->SetTitle("Counts");
X->GetYaxis()->SetTitleSize(0.04);
X->GetYaxis()->SetLabelSize(0.025);
X->SetStats(0);
outTree->Draw("x>>X");
    ///////////////////////////////////////////////////////////////
TCanvas*c041 = new TCanvas("c041", "PKplus", 1600,1100);
    c041->Divide(1,1);
    c041->Print("Q2.pdf[");
    TH1F*Q = new TH1F("Q","Q",100, 0,8);
    c041->cd(1);
    Q->GetXaxis()->SetTitle("Q^{2}");
    Q->GetXaxis()->SetTitleSize(0.04);
    Q->GetXaxis()->SetLabelSize(0.04);
    Q->GetYaxis()->SetTitle("Counts");
    Q->GetYaxis()->SetTitleSize(0.04);
    Q->GetYaxis()->SetLabelSize(0.025);
    Q->SetStats(0);
    outTree->Draw("Q2>>Q");
///////////////////////////////////////////////////////////////
c01->Print("Mxpk.pdf");
