...
FILE * fp = fopen("dihadron_dummy_outd3.txt", "r"); 
...
h55->Divide(h53,h54);
/////////////////////////////////////////////////////////////////////
ofstream outputfile("FitMethodBin8.txt");
int N = h51->GetNbinsX() + 1;  
for(int i=0; i<N; ++i){
outputfile << "\t" << h26->GetBinLowEdge(i)+h26->GetBinWidth(i)/2  << "\t" << h51->GetBinContent(i) << "\t" << h52->GetBinContent(i) << endl; }
outputfile.close(); 
